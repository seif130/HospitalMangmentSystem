...
public sealed class PurchaseOrder: AggregateRoot<PurchaseOrderId>
{
        ...
        Money unitPrice)
    {
        ...
        if (!string.Equals(
            ...
            throw new DomainException(
                "Purchase order line currency must match order currency.");
    ...
    public void Submit()
    {
        ...
        AddDomainEvent(
            new PurchaseOrderSubmittedDomainEvent(Id));
    }
    ...
    public void Approve()
    {
        ...
        AddDomainEvent(
            new PurchaseOrderApprovedDomainEvent(Id));
    }
    ...
    public void Cancel()
    {
        ...
        AddDomainEvent(
            new PurchaseOrderCancelledDomainEvent(Id));
    }
    ...
    public void Complete()
    {
        EnsureStatus(
            ...
            "Only approved purchase orders can be completed.");
