...
public sealed class PurchaseRequest: AggregateRoot<PurchaseRequestId>
{
    ...
    public IReadOnlyCollection<PurchaseRequestLine> Lines
        => _lines.AsReadOnly();
        ...
        string reason)
    {
        ...
        if (string.IsNullOrWhiteSpace(reason))
            throw new DomainException(
                "Purchase request reason is required.");
        ...
        Money estimatedUnitPrice)
    {
        EnsureStatus(
            ...
            "Only draft purchase requests can be modified.");
    ...
    public void Submit()
    {
        ...
        AddDomainEvent(
            new PurchaseRequestSubmittedDomainEvent(Id));
    }
    ...
    public void Approve()
    {
        ...
        AddDomainEvent(
            new PurchaseRequestApprovedDomainEvent(Id));
    }
    ...
    public void Reject(string reason)
    {
        ...
        AddDomainEvent(
            new PurchaseRequestRejectedDomainEvent(
                Id,
                reason.Trim()));
    }
    ...
    public void Cancel()
    {
        if (Status is PurchaseRequestStatus.Approved
            ...
            throw new DomainException(
                "Purchase request cannot be cancelled.");

        Status = PurchaseRequestStatus.Cancelled;
        AddDomainEvent(
            new PurchaseRequestCancelledDomainEvent(Id));
    }
